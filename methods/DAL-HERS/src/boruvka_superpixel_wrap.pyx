...
cdef class BoruvkaSuperpixel:
    ...
    def build_2d(self, feature, affinities, border_strength, *, edgeless=None, seed=None):
        ...
        if not affinities.flags['C_CONTIGUOUS']:
        ...
        cdef np.uint8_t  [:,:,:] affinities_uint8
        cdef np.uint16_t [:,:,:] affinities_uint16
        cdef np.int8_t   [:,:,:] affinities_int8
        cdef np.int16_t  [:,:,:] affinities_int16
        cdef np.int32_t  [:,:,:] affinities_int32
        cdef np.float32_t[:,:,:] affinities_float32
        cdef np.float64_t[:,:,:] affinities_float64
        ...
        if   feature.dtype == np.uint8:
            ...
            affinities_uint8 = affinities
            border_strength_uint8 = border_strength
            self._bosupix.build_2d(shape_x, shape_y, n_feat_ch,
                    &feature_uint8[0,0,0], &affinities_uint8[0,0,0], &border_strength_uint8[0,0],
                    edgeless_ptr, seed_ptr)
        elif feature.dtype == np.uint16:
            feature_uint16 = feature
            affinities_uint16 = affinities
            border_strength_uint16 = border_strength
            self._bosupix.build_2d(shape_x, shape_y, n_feat_ch,
                    &feature_uint16[0,0,0], &affinities_uint16[0,0,0], &border_strength_uint16[0,0],
                    edgeless_ptr, seed_ptr)
        elif feature.dtype == np.int8:
            feature_int8 = feature
            affinities_int8 = affinities
            border_strength_int8 = border_strength
            self._bosupix.build_2d(shape_x, shape_y, n_feat_ch,
                    &feature_int8[0,0,0], &affinities_int8[0,0,0], &border_strength_int8[0,0],
                    edgeless_ptr, seed_ptr)
        elif feature.dtype == np.int16:
            feature_int16 = feature
            affinities_int16 = affinities
            border_strength_int16 = border_strength
            self._bosupix.build_2d(shape_x, shape_y, n_feat_ch,
                    &feature_int16[0,0,0], &affinities_int16[0,0,0], &border_strength_int16[0,0],
                    edgeless_ptr, seed_ptr)
        elif feature.dtype == np.int32:
            feature_int32 = feature
            affinities_int32 = affinities
            border_strength_int32 = border_strength
            self._bosupix.build_2d(shape_x, shape_y, n_feat_ch,
                    &feature_int32[0,0,0], &affinities_int32[0,0,0], &border_strength_int32[0,0],
                    edgeless_ptr, seed_ptr)
        elif feature.dtype == np.float32:
            feature_float32 = feature
            affinities_float32 = affinities
            border_strength_float32 = border_strength
            self._bosupix.build_2d(shape_x, shape_y, n_feat_ch,
                    &feature_float32[0,0,0], &affinities_float32[0,0,0], &border_strength_float32[0,0], edgeless_ptr, seed_ptr)
        elif feature.dtype == np.float64:
            feature_float64 = feature
            affinities_float64 = affinities
            border_strength_float64 = border_strength
            self._bosupix.build_2d(shape_x, shape_y, n_feat_ch,
                    &feature_float64[0,0,0], &affinities_float64[0,0,0], &border_strength_float64[0,0], edgeless_ptr, seed_ptr)
    ...
    def build_3d(self, feature, border_strength):
        ...
        if   feature.dtype == np.uint8:
            ...
            self._bosupix.build_3d(shape_x, shape_y, shape_z, n_feat_ch,
                    &feature_uint8[0,0,0], &border_strength_uint8[0,0,0])
        elif feature.dtype == np.uint16:
            feature_uint16 = feature
            border_strength_uint16 = border_strength
            self._bosupix.build_3d(shape_x, shape_y, shape_z, n_feat_ch,
                    &feature_uint16[0,0,0], &border_strength_uint16[0,0,0])
        elif feature.dtype == np.int8:
            feature_int8 = feature
            border_strength_int8 = border_strength
            self._bosupix.build_3d(shape_x, shape_y, shape_z, n_feat_ch,
                    &feature_int8[0,0,0], &border_strength_int8[0,0,0])
        elif feature.dtype == np.int16:
            feature_int16 = feature
            border_strength_int16 = border_strength
            self._bosupix.build_3d(shape_x, shape_y, shape_z, n_feat_ch,
                    &feature_int16[0,0,0], &border_strength_int16[0,0,0])
        elif feature.dtype == np.int32:
            feature_int32 = feature
            border_strength_int32 = border_strength
            self._bosupix.build_3d(shape_x, shape_y, shape_z, n_feat_ch,
                    &feature_int32[0,0,0], &border_strength_int32[0,0,0])
        elif feature.dtype == np.float32:
            feature_float32 = feature
            border_strength_float32 = border_strength
            self._bosupix.build_3d(shape_x, shape_y, shape_z, n_feat_ch,
                    &feature_float32[0,0,0], &border_strength_float32[0,0,0])
        elif feature.dtype == np.float64:
            feature_float64 = feature
            border_strength_float64 = border_strength
            self._bosupix.build_3d(shape_x, shape_y, shape_z, n_feat_ch,
                    &feature_float64[0,0,0], &border_strength_float64[0,0,0])
