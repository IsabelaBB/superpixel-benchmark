...
#define NIFTI_DT_UNKNOWN                 0     /* what it says, dude           */
#define NIFTI_DT_BINARY                  1     /* binary (1 bit/voxel)         */
#define NIFTI_DT_UNSIGNED_CHAR           2     /* unsigned char (8 bits/voxel) */
#define NIFTI_DT_SIGNED_SHORT            4     /* signed short (16 bits/voxel) */
#define NIFTI_DT_SIGNED_INT              8     /* signed int (32 bits/voxel)   */
#define NIFTI_DT_FLOAT                  16     /* float (32 bits/voxel)        */
#define NIFTI_DT_COMPLEX                32     /* complex (64 bits/voxel)      */
#define NIFTI_DT_DOUBLE                 64     /* double (64 bits/voxel)       */
#define NIFTI_DT_RGB                   128     /* RGB triple (24 bits/voxel)   */
#define NIFTI_DT_ALL                   255     /* not very useful (?)          */
...
#define NIFTI_DT_RGB24                 128
                            ...
                            /*------------------- new codes for NIFTI ---*/
#define NIFTI_DT_INT8                  256     /* signed char (8 bits)         */
#define NIFTI_DT_UINT16                512     /* unsigned short (16 bits)     */
#define NIFTI_DT_UINT32                768     /* unsigned int (32 bits)       */
#define NIFTI_DT_INT64                1024     /* long long (64 bits)          */
#define NIFTI_DT_UINT64               1280     /* unsigned long long (64 bits) */
#define NIFTI_DT_FLOAT128             1536     /* long double (128 bits)       */
#define NIFTI_DT_COMPLEX128           1792     /* double pair (128 bits)       */
#define NIFTI_DT_COMPLEX256           2048     /* long double pair (256 bits)  */
#define NIFTI_DT_RGBA32               2304     /* 4 byte RGBA (32 bits/voxel)  */
/* @} */
