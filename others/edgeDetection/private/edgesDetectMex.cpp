...
void mexFunction( int nl, mxArray *pl[], int nr, const mxArray *pr[] )
{
  ...
  const mwSize indDims[3] = {(mwSize)h1,(mwSize)w1,(mwSize)nTreesEval};
  const mwSize outDims[3] = {(mwSize)h2,(mwSize)w2,(mwSize)1};
  const mwSize segDims[5] = {(mwSize)gtWidth,(mwSize)gtWidth,(mwSize)h1,(mwSize)w1,(mwSize)nTreesEval};
