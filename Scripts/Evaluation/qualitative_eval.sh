...
DS_NAME=$1 # Name of the dataset to evaluate
SPX1=$2 # Number of superpixels of the top left image
SPX2=$3 # Number of superpixels of the bottom right image
DIST=$4 # x,y distance to draw the divisor line. Use -1 for maximum distance
